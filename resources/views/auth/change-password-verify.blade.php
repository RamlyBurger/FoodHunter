...
<head>
    ...
    <title>Verify OTP - FoodHunter</title>
...
<body class="login-layout light-login">
    ...
    <script>
        ...
        async function sendOtpEmail(isResend = false) {
            try {
                const { error } = await supabaseClient.auth.signInWithOtp({ email: userEmail });
        ...
        document.getElementById('resendLink').addEventListener('click', async function(e) {
            ...
            try {
                const response = await fetch('/auth/change-password/resend-otp', {
                    method: 'POST',
                    headers: {
        ...
        document.getElementById('verifyOtpForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('/auth/change-password/verify', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': csrfToken,
