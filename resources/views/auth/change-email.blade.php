{{--
|==============================================================================
| Change Email Page - Ng Wayne Xiang (User & Authentication Module)
|==============================================================================
|
| @author     Ng Wayne Xiang
| @module     User & Authentication Module
|
| Email change request with OTP verification via Supabase.
...
<head>
    ...
    <title>Change Email - FoodHunter</title>
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <p style="color: #666; margin-bottom: 20px;">
                                Enter your new email address. An OTP will be sent to verify the change.
                            </p>
                            ...
                            <form id="changeEmailForm">
                                ...
                                <label class="block clearfix">
                                    <span class="block input-icon input-icon-right">
                                        <input type="email" name="new_email" id="new_email" placeholder="New Email Address" required />
                                        <i class="fa fa-envelope"></i>
                                    </span>
                                </label>
                                ...
                                <label class="block clearfix">
                                    <span class="block input-icon input-icon-right">
                                        <input type="email" name="new_email_confirmation" id="new_email_confirmation" placeholder="Confirm New Email" required />
                                        <i class="fa fa-envelope"></i>
                                    </span>
                                </label>
                        ...
                        <div class="toolbar clearfix">
                            <div>
                                <a href="{{ Auth::check() && Auth::user()->vendor ? '/profile/vendor' : '/profile' }}">
            ...
            try {
                ...
                if (data.success) {
                    Swal.fire({
                        icon: 'success',
                        title: 'OTP Sent!',
                        text: 'An OTP has been sent to your new email. Redirecting...',
                        timer: 2000,
                        showConfirmButton: false
                    }).then(() => {
                        window.location.href = '/auth/change-email/verify';
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
