...
<head>
    ...
    <title>Forgot Password - FoodHunter</title>
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    ...
                    <div class="login-container">
                        ...
                        <div class="position-relative">
                            <div id="forgot-box" class="login-box visible widget-box no-border">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="clearfix">
                                                    <button type="submit" class="width-45 pull-right btn btn-sm btn-primary">
                                                        ...
                                                        <span class="bigger-110">Send Reset Link</span>
                                                    </button>
                                                </div>
