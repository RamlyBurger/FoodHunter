...
<head>
    ...
    <title>Register - FoodHunter</title>
    ...
    <style>
        * {
        ...
        .btn-success:hover {
            background-color: #6b9e62 !important;
            border-color: #5a8b52;
        }
        .width-35 { width: 35%; }
        ...
        .toolbar a, .toolbar a.back-to-login-link {
            font-family: 'Open Sans', sans-serif;
            line-height: 1.5;
            text-align: left;
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <div class="alert alert-danger py-2 mb-3">
                                            ...
                                            <small><i class="fa fa-exclamation-circle me-1"></i>{{ $error }}</small><br>
                                            @endforeach
                                        </div>
                                        @endif

                                        <form name="registerForm" id="registerForm" action="{{ url('/register') }}" method="post" autocomplete="off">
                                            @csrf
                                            <fieldset>
                                                ...
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="tel" name="phone" id="phone" class="form-control" placeholder="Phone Number (optional)" value="{{ old('phone') }}">
                                                ...
                                                <label class="block clearfix">
                                                    <div style="display: flex; gap: 15px; margin-bottom: 10px;">
                                                        <label style="display: flex; align-items: center; cursor: pointer;">
                                                            <input type="radio" name="role" value="customer" checked style="margin-right: 5px;">
                                                            <span style="color: #478fca; font-weight: 500;">
                                                                <i class="ace-icon fa fa-shopping-cart"></i> Customer
                                                            </span>
                                                        </label>
                                                        <label style="display: flex; align-items: center; cursor: pointer;">
                                                            <input type="radio" name="role" value="vendor" style="margin-right: 5px;">
                                                            <span style="color: #87b87f; font-weight: 500;">
                                                                <i class="ace-icon fa fa-store"></i> Vendor
                                                            </span>
                                                        </label>
                                                    </div>
                                                </label>
                                                ...
                                                <div class="clearfix">
                                                    <button type="submit" class="width-35 pull-right btn btn-sm btn-success" id="submitBtn">
                                                        <i class="ace-icon fa fa-check"></i>
                                        ...
                                        <div class="social-login left">
                                            <a href="{{ route('auth.google') }}" class="btn">
                                                ...
                                                <span class="blue" style="margin-left: 10px;">Sign up with Google</span>
                                            </a>
                                        </div>
                                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        password.addEventListener('input', function() {
            ...
            if (result.strength < 25) {
                ...
                strengthText.innerHTML = '<span class="text-info">Fair</span> - Add: ' + result.feedback.join(', ');
        ...
        function checkMatch() {
            ...
            if (password.value === confirm.value) {
                matchText.innerHTML = '<span class="text-success"><i class="fa fa-check-circle"></i> Passwords match</span>';
            } else {
                matchText.innerHTML = '<span class="text-danger"><i class="fa fa-times-circle"></i> Passwords do not match</span>';
            }
        }
    });
    </script>
